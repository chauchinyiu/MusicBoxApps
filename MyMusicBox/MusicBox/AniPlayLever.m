...
-(id)initWithOffSetX:(GLfloat)x OffSetY:(GLfloat)y{
    ...
    playShadow.alpha = 1.0f;
    playShadow.followShift = true;
    ...
    playLeverShadow.alpha = 1.0f;
    playLeverShadow.followShift = true;
    ...
    playLever.alpha = 1.0f;
    playLever.followShift = true;
    ...
    playBtnBg.alpha = 1.0f;
    playBtnBg.followShift = true;
