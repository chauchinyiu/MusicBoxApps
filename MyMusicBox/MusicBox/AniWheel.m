...
-(id)initWithOffSetX:(GLfloat)x OffSetY:(GLfloat)y{
    ...
    wheelShadow.alpha = 1.0f;
    wheelShadow.followShift = true;
    ...
    wheelMask.alpha = 1.0f;
    wheelMask.followShift = true;
    ...
    blackOnWheel.alpha = 1.0f;
    blackOnWheel.followShift = true;
    ...
    blackStick.alpha = 1.0f;
    blackStick.followShift = true;
