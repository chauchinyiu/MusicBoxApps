...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  // Override point for customization after application launch.
    ...
    [Everyplay setClientId:@"89ce054e00ec20129fb920ff70edfb0bab135e5f" clientSecret:@"33ae3b2cdbd8038a97f16aabf3bca35b84080c7d" redirectURI:@"https://m.everyplay.com/auth"];
...
//    NSLog(@"%f height", [UIScreen mainScreen].bounds.size.width);
//    if(IS_IPHONE_5){
        return @"-568h";
//    }else{
//        return @"";
